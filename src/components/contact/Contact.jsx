...
const Contact = () => {
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          toast.error("Please try again or contact with us on whatsapp", {
            position: "top-right",
            autoClose: 3000,
            theme: "colored",
          });
  ...
  return (
    <section className="contact section" id="Contact">
      <ToastContainer />
      <h2 className="section__title" title="Contact Section Title">
        Get In Touch
      </h2>
