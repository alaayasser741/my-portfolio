    ...
    useEffect(() => {
        axios.get('js/data.json')
            .then(response => {
                ...
                const data = response.data.Frontend;
                if (data.length > 0) {
